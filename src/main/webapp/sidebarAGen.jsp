...
<div class="flex flex-row position-sticky">
  <!-- Sidebar -->
      <nav class="bg-blue-900 w-20 justify-between flex flex-col h-screen fixed-top">
        <div class="mt-10 mb-10">
          <a href="dashboardAdminGen.jsp">
            <img
          ...
          <div class="mt-10">
            <ul>
              ...
              <li class="mb-12">
                <a href="dashboardAdminGen.jsp">
                  <i class="fa fa-user text-gray-300 hover:text-yellow-300" aria-hidden="true"></i>
                </a>
              </li>
              <li class="mb-12">
              <a href="addCenterAdmin.jsp">
                 <i class="fas fa-plus text-gray-300 hover:text-yellow-200"></i>
              </a>
            </li>
              <li class="mb-12">
